...
class Test_Local_Compiler(unittest.TestCase):       

    def setUp(self):
        self._default_compiler = LocalCompiler('test-project-name')

    def _expected_arguments(self, root_directory):
        return [
    ...
    @patch('os.makedirs')
    def test_create_project_directories_default_file_location(self, mock_make_dirs: Mock, mock_is_file: Mock) -> None:
    ...
    @patch('os.path.isfile')
    @patch('os.makedirs')
    def test_create_project_directories_with_custom_file_location(self, mock_make_dirs: Mock, mock_is_file: Mock) -> None:
        mock_is_file.return_value = True
    ...
    @patch('os.path.isfile')
    @patch('os.makedirs')
    def test_create_project_directories_with_file_already_exist(self, mock_make_dirs: Mock, mock_is_file: Mock) -> None:
